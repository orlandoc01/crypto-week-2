...
declare module 'lodash' {
  ...
  declare class Lodash {
    ...
    isEqualWith<T, U>(value: T, other: U, customizer?: (objValue: any, otherValue: any, key: number | string, object: T, other: U, stack: any) => boolean | void): boolean;
    ...
    isMatchWith<T: Object, U: Object>(object: T, source: U, customizer?: (objValue: any, srcValue: any, key: number | string, object: T, source: U) => boolean | void): boolean;
    ...
    bindAll(object?: ?Object, ...methodNames: Array<string>): Object;
    cond<T,U,V,W>(pairs: Array<[(T, U, V) => boolean, (T,U,V) => W]>): (T,U,V) => W;
    ...
    matches(source: Object | string): Function;
